...
import footerBg from "../assets/white_bg.jpeg";

function Footer() {
  return (
    <div
      className="relative z-10 text-gray-800 px-6 py-10 bg-cover bg-center bg-no-repeat "
    ...
    >
      <div className="flex flex-col lg:flex-row justify-between items-center lg:items-start gap-10 max-w-6xl mx-auto">
        ...
        <div className="lg:w-1/3 text-center lg:text-left">
          <img className="w-24 mx-auto lg:mx-0 mb-4" src={Logo} alt="Logo" />
          <p className="text-sm mb-2 font-medium">
            Where innovation meets cultivation. <br />
            <strong>Rathee Agrotech</strong> – Farming redefined under one roof.
          </p>
          <p className="text-green-800 text-sm font-bold mt-4">
        ...
        <div className="lg:w-1/6 text-center lg:text-left">
          <h4 className="font-bold text-lg mb-3 text-[#4baf47]">Site Links</h4>
